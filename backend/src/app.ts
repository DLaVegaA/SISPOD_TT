...
app.use('/api/tipo-cita',               tipoCitasRoutes)      // ← FIX: era /api/tipo-citas
app.use('/api/consentimiento',          consentimientoRoutes)
app.use('/api/consentimientos',         consentimientoRoutes) // ← FIX: alias plural (getById lo llama así)
app.use('/api/bitacora',                bitacoraRoutes)       // ← FIX: era /api/bitacoras
app.use('/api/expediente',             expedienteRoutes)
app.use('/api/padecimiento',           padecimientosRoutes)
app.use('/api/catalogo-procedimientos', catalogoProcedimientosRoutes)
app.use('/api/catalogo-procedimientos', errorHandler)
app.use('/api/seguimiento',             seguimientoRoutes)
app.use('/api/seguimiento',             errorHandler)
app.use('/api/odontograma',             odontogramaRoutes)
app.use('/api/odontograma',             errorHandler)
app.use('/api/pregunta',                errorHandler)
app.use('/api/cuestionario',            cuestionarioRoutes)
app.use('/api/cuestionario',            errorHandler)
app.use('/api/preguntas-base',          preguntaBaseRoutes)
app.use('/api/preguntas-base',          errorHandler)
app.use('/api/padecimiento',            errorHandler)
app.use('/api/expediente',             errorHandler)
app.use('/api/bitacora',                errorHandler)
app.use('/api/consentimiento',          errorHandler)
app.use('/api/asistentes',              asistenteRoutes)      // ← FIX: era /api/asistente
