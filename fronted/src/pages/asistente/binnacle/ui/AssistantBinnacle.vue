...
// En este caso, el rol está fijo como 'Asistente'
const currentUserRole = ref<'Dentista' | 'Asistente'>('Asistente') 
...
const logs = ref<LogEntry[]>([
  ...
  // Esta bitácora 'Anulada' no debe ser vista por el Asistente (RN8)
  {
    id: 'BIT-007',
...
// El Asistente no debe poder filtrar ni seleccionar 'Anulada'
  ...
  <div class="fade-in max-w-7xl mx-auto pb-10">
    ...
    <div class="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-8">
      <div>
        ...
        <p class="text-sm text-muted mt-1">Consulta y registro de atenciones y procedimientos.</p>
      </div>

      <!-- CU17 Crear Bitácora: El asistente TIENE permiso para crear -->
      <button
        ...
        >
          ...
          >
            ...
            <div class="flex items-center gap-1 justify-end" @click.stop>
              <!-- RN8: Al Asistente se le restringe la edición y eliminación. Solo puede Ver (Expandir) y Descargar -->
              <button
