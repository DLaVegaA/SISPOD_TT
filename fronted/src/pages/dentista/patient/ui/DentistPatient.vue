  ...
  <div class="fade-in">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
      ...
      <div class="flex items-center gap-3">
        <button
          class="px-4 py-2.5 bg-card border border-border rounded-2xl text-sm font-semibold text-black hover:bg-surface transition-colors"
        >
          Hoy
        </button>
        ...
        <div class="relative">
          <select
            class="appearance-none bg-card border border-border rounded-2xl px-4 py-2.5 pr-9 text-sm font-semibold text-black hover:bg-surface transition-colors focus:outline-none focus:border-accent cursor-pointer"
          >
      ...
      <table class="w-full">
        ...
        <thead>
          <tr class="border-b border-border bg-surface">
            <th
              class="text-left px-5 py-4 text-xs font-semibold text-muted uppercase tracking-wider"
            >
              ID
            </th>
            <th
            ...
            <th
              class="px-5 py-4 text-xs font-semibold text-muted uppercase tracking-wider text-right"
            >
              Expedientes
            </th>
          </tr>
          ...
          >
            ...
            <td class="px-5 py-5">
              <div class="flex flex-col gap-1.5 items-end">
                <button
                  class="flex items-center gap-1 text-[10px] font-semibold text-accent hover:text-accent-light uppercase transition-colors"
                >
