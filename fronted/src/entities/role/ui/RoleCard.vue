<template>
  <div
    class="bg-card border border-border rounded-2xl p-6 hover:border-accent/30 transition-colors"
  >
...
import { CheckCircle2, Headset, Shield, Stethoscope, User } from 'lucide-vue-next'
...
const iconComponent = computed(() => iconMap[props.role.icon] ?? User)
</script>
