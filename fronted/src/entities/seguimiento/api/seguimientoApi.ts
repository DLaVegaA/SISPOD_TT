...
// ─────────────────────────────────────────────────────────────────────────────
// Rutas en singular — según server.ts:
...
export const seguimientoApi = {
  ...
  listar(estado?: EstadoSeguimiento) {
    return httpClient.get('/seguimiento', {
      ...
      seguimientos: SeguimientoListItem[]
      total: number
    }>
  },
  ...
  // GET /seguimiento/:id/cuestionario/:tipo
  ...
  // POST /seguimiento/:id/respuestas  ← PENDIENTE implementar en backend
