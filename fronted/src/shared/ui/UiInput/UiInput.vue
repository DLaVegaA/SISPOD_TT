<template>
  <div class="w-full">
    <label v-if="label" class="block text-xs font-semibold text-muted uppercase tracking-wider mb-2">
      {{ label }}
    </label>
    <div class="relative">
      <component
      ...
      <input
        ...
        :class="[
          'w-full bg-surface border rounded-xl py-2.5 text-sm text-black placeholder-muted focus:outline-none transition-colors',
